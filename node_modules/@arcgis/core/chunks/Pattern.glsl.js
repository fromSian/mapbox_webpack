...
return rayOrigin + t * rayDir;
    ...
    vec2 scaledUV() {
      ...
      vec2 uvOffset = mod(uvCellOrigin * discreteWorldToScreenRatio, ${d.float(m.patternSpacing)});
...
return accumulator;
  ...
  `),f}function g(e){function t(t){return e.draped?d`coverage(vuv.${t}, texelSize)`:d`sample(vuv.${t})`}switch(e.style){case 3:case 0:return t("y");case 4:case 1:return t("x");case 5:case 2:return d`
        1.0 - (1.0 - ${t("x")}) * (1.0 - ${t("y")})
      `;default:return"0.0"}}const f=Object.freeze({__proto__:null,build:m});export{f as P,m as b};
